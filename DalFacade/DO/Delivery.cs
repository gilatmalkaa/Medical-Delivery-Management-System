...
/// Each delivery has a unique ID and connects a specific order with a specific courier.
/// It also stores delivery type, distance details, and completion status.
/// </summary>
...
/// <param name="ExpectedDistance">Calculated expected distance (in km) based on system logic.</param>
